...
urlpatterns = [
    ...
    path(
        "ucet/set_preference/", core_views.set_preference, name="account-set-preference"
    ),
    ...
    path(
        "ucet/fotky/upravit/<int:photo_id>/",
        photos_views.edit,
        name="account-photos-edit",
    ),
    path(
        "ucet/fotky/smazat/<int:photo_id>/",
        photos_views.delete,
        name="account-photos-delete",
    ),
    ...
    re_path(
        r"^fotoforum/den/(?P<date>\d{3,4}-\d\d-\d\d)/$",
        discussion_views.comment_list,
        {"action": "date"},
        name="comment-date",
    ),
    ...
    path(
        "fotoforum/komentar/<int:obj_id>/",
        discussion_views.comment_detail,
        name="comment-detail",
    ),
    path(
        "fotoforum/vlakno/<int:obj_id>/",
        discussion_views.comment_thread,
        name="comment-thread",
    ),
    path(
        "fotogalerie/",
        ...
        {"action": "time"},
        name="photos-listing-time",
    ),
    re_path(
        r"^fotogalerie/den/(?P<date>\d{3,4}-\d\d-\d\d)/$",
        photos_views.listing,
        {"action": "date"},
        name="photos-listing-date",
    ),
    path(
        "fotogalerie/komentare/",
    ...
    re_path(
        r"^fotogalerie/mesic/(?P<month>\d{3,4}-\d\d)/$",
        photos_views.listing,
        {"action": "month"},
        name="photos-listing-month",
    ),
    path("fotogalerie/sekce/", photos_views.themes, name="photos-sections"),
    path(
        "fotogalerie/sekce/0/",
        photos_views.listing,
        {"action": "section", "section": None},
        name="photos-listing-no-section",
    ),
    path(
        "fotogalerie/sekce/<int:section>/",
        photos_views.listing,
        {"action": "section"},
        name="photos-listing-section",
    ),
    path(
        "fotogalerie/skore/",
    ...
    path(
        "workshopy/workshop/<int:obj_id>/",
        workshops_views.detail,
